...
function syncSeo(index) {
  ...
  const imageAlt = [
    '冷凍兔肉的小基地：紙張底色、藍色標籤與綠髮角色貼紙。',
    '冷冻兔肉的小基地：纸张底色、蓝色标签与绿发角色贴纸。',
    'Frozen Rabbit’s base with a paper background, blue label and green-haired character sticker.',
    '紙の背景、青いラベル、緑髪のキャラクターステッカーで飾った冷凍うさぎの小さな拠点。',
  ][index];
